...
%% (b) Run Code11 and visualize results
...
for i = 1:num_shapes
    flat_shape = reshape(aligned_shapes_code11{i}', [1, D]);  % Flattening (2x56 → 112x1 → 1x112)
...
figure;
bar(evals(1:3));
title('Top 3 Principal Mode Variances (Code11)');
...
saveas(gcf, 'comparison_modes.png');
end
